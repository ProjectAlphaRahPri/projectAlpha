...
public interface ILogger
{
	 ...
	 */
	public static final String LOG_PATH = System.getProperty("user.dir") + File.separator + "logs"
			+ File.separator;
	 ...
	 * 
	 * @param className name of the class in which the log message was created
	 * @param methodName name of the method in which the log message was created
	 * @param logNotice content of the log message
	 * @param throwable Throwable (Exception or Error) that should be logged
	 */
	void log(Level alevel, String className, String methodName, String logNotice, Throwable throwable);
	 ...
	 * @param throwable Throwable (Exception or Error) that should be logged
	 */
	void log(Level alevel, String className, String methodName, Object[] logNotice,
			Throwable throwable);

	/**
	 * Logs the given notice
	 * 
	 * @param level level of the message (Level.INFO ... LEVEL.ALL) determining,
	 *        if the notice gets logged or ignored
	 * @param className name of the class in which the log message was created
	 * @param methodName name of the method in which the log message was created
	 * @param throwable Throwable (Exception or Error) that should be logged
	 */
	void log(Level alevel, String className, String methodName, Throwable throwable);
	 ...
	 * @param logNotice content of the log message
	 */
	void log(Level alevel, String className, String methodName, String logNotice);
	...
	/**
	 * Sets the Loggers log level. The log level is used to specify if message of
	 * a certain level has to be logged: If the log level of a log message is at
	 * least as important the current log level, the message is written,
	 * otherwise it is ignored.
	 * 
	 * @param level log level as an Level Object (use defined constants like
	 *        ILogger.WARNING)
	 */
	 ...
	 * 
	 * @param formatter new formatter to set the Logger with
	 */
